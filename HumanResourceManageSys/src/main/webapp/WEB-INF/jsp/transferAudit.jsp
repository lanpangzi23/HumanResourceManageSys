...
<input class="easyui" type="radio" style="margin-left:795px; background:#CFC;"/>未通过
<input class="easyui" type="radio" style=" background:#CFC;"/>通过
<input class="easyui" type="button" style=" background:#CFC;" value="确认"/>
<input class="easyui" type="button" style=" background:#CFC;" value="返回"/><br/>
 <table border="1" width="1000px" cellpadding="0" cellspacing="0">
		<tr style="height:35px;">
			<td class="backcolor" style="text-align:center">档案编号</td>
			<td colspan="7" ><input class="easyui" type="text" id="I" name="Ijjg"></td>
        ...
        <td class="backcolor" style="text-align:center">新I级机构</td>
          ...
          <tr style="height:35px;">
           ...
           <tr style="height:35px;">
			...
			<td colspan="7" ><textarea style="width:800px;"></textarea></td>
