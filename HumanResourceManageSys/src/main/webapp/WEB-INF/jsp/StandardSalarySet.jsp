...
<p style="color:#00F">您正在做的业务是：人力资源--薪酬标准管理--薪酬标准登记</p><br/>
    ...
    <table border="1" width="1000px" cellpadding="0" cellspacing="0">
        ...
        <tr style="height:35px;">
			<td style="text-align:center" class="backcolor">1</td>
			
			<td  colspan="3" style="text-align:center" class="backcolor">基本工资</td>
			<td colspan="2"><input class="easyui" type="text" id="I" name="Ijjg"></td>
			
		</tr>
           <tr style="height:35px;">
			<td style="text-align:center" class="backcolor">2</td>
			
			<td  colspan="3" style="text-align:center" class="backcolor">交通补贴</td>
			<td colspan="2"><input class="easyui" type="text" id="I" name="Ijjg"></td>
			
		</tr>
           <tr style="height:35px;">
			<td style="text-align:center" class="backcolor">3</td>
			
			<td  colspan="3" style="text-align:center" class="backcolor">通讯补贴</td>
			<td colspan="2"><input class="easyui" type="text" id="I" name="Ijjg"></td>
			
		</tr>
           <tr style="height:35px;">
			<td style="text-align:center" class="backcolor">4</td>
			
			<td  colspan="3" style="text-align:center" class="backcolor">浮动工资</td>
			<td colspan="2"><input class="easyui" type="text" id="I" name="Ijjg"></td>
			
		</tr>   <tr style="height:35px;">
			<td style="text-align:center" class="backcolor">5</td>
			
			<td  colspan="3" style="text-align:center" class="backcolor">常规</td>
			<td colspan="2"><input class="easyui" type="text" id="I" name="Ijjg"></td>
			
		</tr>
           <tr style="height:35px;">
			<td style="text-align:center" class="backcolor">6</td>
			
			<td  colspan="3" style="text-align:center" class="backcolor">午餐补助</td>
			<td colspan="2"><input class="easyui" type="text" id="I" name="Ijjg"></td>
			
		</tr>
           <tr style="height:35px;">
			<td style="text-align:center" class="backcolor">7</td>
			
			<td  colspan="3" style="text-align:center" class="backcolor">交通补助</td>
			<td colspan="2"><input class="easyui" type="text" id="I" name="Ijjg"></td>
			
		</tr>   <tr style="height:35px;">
			<td style="text-align:center" class="backcolor">8</td>
