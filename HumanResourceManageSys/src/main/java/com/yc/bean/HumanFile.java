...
=======
	 ...
	 * 
	 */
	private static final long serialVersionUID = 328502650000401833L;
	private int huf_id;
>>>>>>> 76e29e14993d9fad9797277f8bbd293f44dddf18
	...
	public String toString() {
		return "HumanFile [huf_id=" + huf_id + ", human_id=" + human_id + ", first_kind_name=" + first_kind_name
				...
				+ human_postcode + ", human_pro_desgination=" + human_pro_designation + ", human_major_kind_id="
				+ human_major_kind_id + ", human_major_kind_name=" + human_major_kind_name + ", human_major_id="
				+ human_major_id + ", human_major_name=" + hunma_major_name + ", human_telephone=" + human_telephone
				+ ", human_mobliephone=" + human_mobilephone + ", human_account=" + human_account + ", human_bank="
				...
				+ salary_standard_name + ", salary_sum=" + salary_sum + ", demand_salary_sum=" + demand_salaray_sum
				+ ", paid_salary_sum=" + paid_salary_sum + ", major_change_amount=" + major_change_amount
				+ ", bonus_amount=" + bonus_amount + ", training_amount=" + training_amount + ", file_change_amount="
				+ file_change_amount + ", human_history_records=" + human_history_records + ", human_family_membership="
				+ human_family_membership + ", human_picture=" + human_picture + ", attchment_name=" + attchment_name
	...
	public void setHuman_major_name(String human_major_name) {
		this.hunma_major_name = human_major_name;
	}
	...
	public void setHuman_mobliephone(String human_mobliephone) {
		this.human_mobilephone = human_mobliephone;
	}
	...
	public void setDemand_salary_sum(double demand_salary_sum) {
		this.demand_salaray_sum = demand_salary_sum;
	}
